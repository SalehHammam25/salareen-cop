...
from salareen_cop.cloud_tunneling.config import load_tunnel_config
from salareen_cop.cloud_tunneling.endpoints import (
    redact_endpoint,
    validate_remote_endpoint,
)
from salareen_cop.cloud_tunneling.exchange import (
    EndpointExchange,
    load_opponent_endpoint,
)
from salareen_cop.cloud_tunneling.models import TunnelEndpoint, TunnelFailure


def test_defaults_match_annex_f_and_never_read_credential() -> None:
...
def test_remote_endpoint_requires_safe_public_https() -> None:
    ...
    rejected = (
        ...
        "https://peer.example.test/mcp?mode=unsafe",
