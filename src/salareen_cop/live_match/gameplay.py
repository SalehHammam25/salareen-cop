...
from salareen_cop.base_logic.actions import (
    BarrierAction,
    CaptureClaim,
    MoveAction,
    MoveChoice,
)
from salareen_cop.base_logic.capture import adjacent_destinations
from salareen_cop.base_logic.config_loader import load_config
...
from salareen_cop.base_logic.scoring import ScoreAccepted, score_episode
from salareen_cop.base_logic.state_factory import build_state, initial_state
...
from salareen_cop.scent.field import empty_field, evolve
...
class GameplayAdapter:
    def __init__(self, config_path: str | Path, saved: str | None = None) -> None:
        ...
        self.gateway = StrategyGateway(self.rules, BlindCopPolicy())
